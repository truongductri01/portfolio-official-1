    ...
    return (
        <div>
            ...
            <p className="desc text-normal text-justify">
                I have done three internships with <strong>Intuit</strong> in the
                last 3 years which give me the understanding of not only how
                softwares are planned, developed, and deployed but also how
                they make customers' life easier. I have worked closely
